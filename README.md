...
const colaborador = await Func.create({	
	...
	rg: req.body.rg, cpf: req.body.cpf,
	dt_nasc : req.body.dt_nasc,
	cnh : req.body.cnh,
	atec_criminal_estadual : req.body.atcrimestd,
	atec_criminal_federal: req.body.atcrimefed,
	cargo : req.body.cargo,
	cart_trabalho : req.body.cart_trabalho,
	cert_negativa_estd : req.body.certnegativaest,
	cert_negativa_feder : req.body.certnegativafed,
	foto : req.body.foto,
	createdAt : new Date(),
	updatedAt : new Date()
